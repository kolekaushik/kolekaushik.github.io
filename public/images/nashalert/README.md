# NashAlert screenshots

This folder holds the screenshot gallery images for the NashAlert card in the
...
1. Export 2–3 real screenshots of NashAlert (PNG or JPG recommended, ~1200px
   wide is plenty for the gallery card size).
2. Drop them in this folder, e.g. `1.png`, `2.png`, `3.png`.
3. Update the `images` array for the `nashalert` entry in
